...
void RosJog::initPlugin(qt_gui_cpp::PluginContext& context)
{
  ...
  connect(x_plus_btn_, &QPushButton::clicked,
          [this]() { handleButtonClick(1.0, 0.0, 0.0); });
  connect(x_minus_btn_, &QPushButton::clicked,
          [this]() { handleButtonClick(-1.0, 0.0, 0.0); });
  connect(y_plus_btn_, &QPushButton::clicked,
          [this]() { handleButtonClick(0.0, 1.0, 0.0); });
  connect(y_minus_btn_, &QPushButton::clicked,
          [this]() { handleButtonClick(0.0, -1.0, 0.0); });
  connect(z_plus_btn_, &QPushButton::clicked,
          [this]() { handleButtonClick(0.0, 0.0, 1.0); });
  connect(z_minus_btn_, &QPushButton::clicked,
          [this]() { handleButtonClick(0.0, 0.0, -1.0); });

  connect(a_plus_btn_, &QPushButton::clicked,
          [this]() { handleButtonClick(1.0, 0.0, 0.0); });
  connect(a_minus_btn_, &QPushButton::clicked,
          [this]() { handleButtonClick(-1.0, 0.0, 0.0); });
  connect(b_plus_btn_, &QPushButton::clicked,
          [this]() { handleButtonClick(0.0, 1.0, 0.0); });
  connect(b_minus_btn_, &QPushButton::clicked,
          [this]() { handleButtonClick(0.0, -1.0, 0.0); });
  connect(c_plus_btn_, &QPushButton::clicked,
          [this]() { handleButtonClick(0.0, 0.0, 1.0); });
  connect(c_minus_btn_, &QPushButton::clicked,
          [this]() { handleButtonClick(0.0, 0.0, -1.0); });

  // Initialize ROS publisher
  controller_manager_client_->switchController({ controller_name_ },
